import { StyleSheet, Text,Button, View,Pressable, Image,  TouchableWithoutFeedback, TouchableOpacity, Modal,FlatList } from 'react-native'
              ...
              <View style= {{
                ...
                elevation: 2
                  ...
                  <View style={{flex:16}}>
                    ...
                    <View style={{flexDirection:'row'}}>
                      <Text style={{flex: 1.5}}>Time:</Text>
                      <Text style={{flex: 3}}>{item.time}</Text>
                    </View>
                    <View style={{flexDirection:'row'}}>
                      <Text style={{flex: 1.5}}>Instructions:</Text>
                      <Text style={{flex: 3}}>{item.instruction}</Text>
                    </View>
...
const styles = StyleSheet.create({
    ...
    footer: {
      padding: 10,
      backgroundColor: '#a9c1eb', // Transparent background color
      alignItems: 'center',
    },
    footerText: {
      color: '#fff',
